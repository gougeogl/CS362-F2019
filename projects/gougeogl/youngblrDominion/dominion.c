...
//Refactor Mine
    case mine:
        refactoredMine(j, i, choice1, choice2, currentPlayer, state, handPos);
...
//Refactor Baron code
    case baron:
        refactoredBaron(choice1, currentPlayer, state);
...
//Refactor Tribute
    case tribute:
        refactoredTribute(i, tributeRevealedCards, currentPlayer, nextPlayer, state);


//Refactor Ambassador
    case ambassador:
      refactoredAmbassador(j, i, choice1, choice2, currentPlayer, state, handPos);
