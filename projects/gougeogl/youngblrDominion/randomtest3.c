...
int randomTributeTest()
{
	...
	/* ** PRIMARY TESTING LOOP: ITERATES 10,000 TIMES */
	do
	{
		// number of players
		...
		initTestGame(newNumPlayers, kingdomCards, newSeed, &G);

		int currentPlayer = _genRandRange(2, newNumPlayers);
		...
		int newFillSize = _genRandRange(0, MAX_DECK);
